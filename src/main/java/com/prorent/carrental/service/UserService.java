...
public class UserService {
	...
	public void updateUserAuth(Long id, AdminDTO adminDTO) throws BadRequestException {
		...
		User user = new User(id, adminDTO.getFirstName(), adminDTO.getLastName(), adminDTO.getEmail(),
				adminDTO.getPassword(), adminDTO.getPhoneNumber(), adminDTO.getAddress(), adminDTO.getZipCode(),
	...
	public void removeById(Long id) throws ResourceNotFoundException {
		...
		if (exists) {
			throw new BadRequestException("User is used by a reservation");
		}
